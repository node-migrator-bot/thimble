...
exports.create = function(options) {
  ...
  thimble.node_modules = join(dirname(process.argv[1]), 'node_modules');
...
var eval = exports.eval = function(content, locals, fn) {
  ...
  // Add after compile, because if we pass markdown or jade through
  // we need to compile it to HTML before wrapping it in the layout
  if (locals.layout) {
    options.layout = locals.layout;
    // Place on layout plugin top of stack
    self.stack.push(self.layout());
  }
...
/*
  Public: Register rendering engines to thimble

  Example: thimble.engine('.mu', require('github-flavored-markdown'))
*/
