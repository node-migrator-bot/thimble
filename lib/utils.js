...
/*
  Try a few requires
*/
var tryRequire = exports.tryRequire = function(module, options) {
  if(cache[module]) return cache[module];

  try {
    return cache[module] = require(module);
  } catch(e) {
    try {
      return cache[module] = require(join(options.node_modules, module));
    } catch(e) {
      throw e;
    }
  }
