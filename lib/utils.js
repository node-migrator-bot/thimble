...
*/
var needs = exports.needs = function() {
  var fn, keys, obj, _i, key;

  keys = 3 <= arguments.length ? 
    slice.call(arguments, 0, _i = arguments.length - 2) : 
    (_i = 0, []), obj = arguments[_i++], fn = arguments[_i++];
...
/*
  ...
  TODO: Fix this too
*/
var mkdirs = exports.mkdirs = function() {
  var dirs, finished, fn, _i;
  dirs = 2 <= arguments.length ? slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), fn = arguments[_i++];
